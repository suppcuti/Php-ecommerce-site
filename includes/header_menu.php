                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="nav navbar-nav">
                       ...
                       if (isset($_SESSION['email']) && $_SESSION['email'] == 'admin@gmail.com') {
                        ?>
                       <li class="nav-item"><a href="admin-add.php" class="nav-link">Add Product</a></li>
                       <li class="nav-item"><a href="admin-view.php" class="nav-link">Admin View</a></li>
                       <li class="nav-item"><a href="admin-check.php" class="nav-link">Cart History</a></li>
                       <?php
                          } 
                        ?>
                    </ul>
